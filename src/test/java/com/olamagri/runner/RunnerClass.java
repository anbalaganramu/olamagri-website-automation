...
import com.olamagri.utils.DriverClass;
...
@CucumberOptions(features = { "src/test/resources/Features" }, glue = { "com.olamagri.stepDefinitions" }, plugin = {
